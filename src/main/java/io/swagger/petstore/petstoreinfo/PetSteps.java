...
public class PetSteps {
    ...
    public ValidatableResponse createPet(int Id, PetDataPojo.CategoryData categoryData, String Name,
                                         ArrayList<String> photoList, ArrayList<PetDataPojo.TagData> tagDataList,
                                         String status) {

        PetDataPojo petBodyDataPojo = new PetDataPojo();
    ...
    public ValidatableResponse updatePetRecord(int Id, PetDataPojo.CategoryData categoryData, String Name,
                                               ArrayList<String> photoList, ArrayList<PetDataPojo.TagData> tagDataList,
                                               String status) {
        PetDataPojo petBodyDataPojo = new PetDataPojo();
        petBodyDataPojo.setId(Id);
